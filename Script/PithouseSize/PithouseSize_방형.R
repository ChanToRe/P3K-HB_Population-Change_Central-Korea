...
#결측치 제거
df <- na.omit(df)
df <- subset(df, df$Type == "백제(방형)" | df$Type == "신라(방형)" | df$Type == "고구려(방형)")
...
tiff(file="/Users/jch/Documents/github/P3K-HB_Demography/Graph/Demographics(Pithouse Size - 방형).tiff", units='in', res=300, width=7, height=5)
...
tiff(file="/Users/jch/Documents/github/P3K-HB_Demography/Graph/Boxplot(Pithouse Size - 방형).tiff", units='in', res=300, width=7, height=5)
