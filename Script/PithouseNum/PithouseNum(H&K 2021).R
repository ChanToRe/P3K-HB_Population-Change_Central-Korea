...
tiff(file="/Users/jch/Documents/github/P3K-HB_Demography/Graph/Pithouse Num(Han&Kang 2021).tiff", units='in', res=300, width=7, height=5)
barplot(bardata$barsize, space=0, names.arg = bardata$barname, width=c(1, 1, 1, 1, 1))
