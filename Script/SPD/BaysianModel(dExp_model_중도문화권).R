...
# Plot
tiff(file="C:/github/P3K-HB_Demography/Graph/dexp_HPD(중도문화권).tiff", units='in', res=300, width=8, height=3)
par(mfrow=c(1,3))
...
tiff(file="C:/github/P3K-HB_Demography/Graph/dexp_model(중도문화권).tiff", units='in', res=300, width=7, height=5)
par(mfrow=c(1, 1))
...
tiff(file="C:/github/P3K-HB_Demography/Graph/dexp_fit(중도문화권).tiff", units='in', res=300, width=7, height=7)
par(mfrow=c(1, 1))
