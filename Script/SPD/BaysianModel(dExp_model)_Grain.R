...
# Plot
tiff(file="/Users/jch/Documents/github/P3K-HB_Demography/Graph/HPD(Grain).tiff", units='in', res=300, width=8, height=3)
par(mfrow=c(1,3))
...
tiff(file="/Users/jch/Documents/github/P3K-HB_Demography/Graph/Baysian Model(dExp_model)_Grain.tiff", units='in', res=300, width=7, height=5)
par(mfrow=c(1, 1))
