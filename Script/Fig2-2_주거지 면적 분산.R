...
tiff(file=here("./Graph/Fig2-2(1)_방형주거지 면적 분산.tiff"), units='in', res=300, width=7, height=4)
...
title(ylab="Size(cm²)", col.lab="black")
dev.off()
...
tiff(file=here("./Graph/Fig2-2(2)_여철자형주거지 면적 분산.tiff"), units='in', res=300, width=7, height=4)
